...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_digital008/3a40faa7a728e09c428122c9a8194aea/execroot/__main__',
    'iphone',
    {
        'ios_x86_64': [
        ...
        '//:app': BazelFlagsSet(
            flags = BazelFlags(
                ...
                build = [
                    ...
                    '--override_repository=xchammer_tulsi_aspects=/usr/local/bin/xchammer.app/Contents/Resources',
                    '--override_repository=tulsi=/usr/local/bin/xchammer.app/Contents/Resources',
                    '--override_repository=xchammer=/usr/local/bin/xchammer.app/Contents/Resources',
                    '--aspects',
                    '@xchammer//:BazelExtensions/xcode_configuration_provider.bzl%xcode_build_sources_aspect',
